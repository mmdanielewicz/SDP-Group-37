...
# Now import orchestration as a real package module
...
def handle_user_query(query: str, lat=41.2940, lon=-72.3768, state="CT"):
    ...
    We DO NOT touch any backend code here; we just call orchestration.main(query)
    and return whatever it gives us.
    """
    try:
